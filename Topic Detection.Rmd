...
ggplot(topic_1_thr[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
...
ggplot(topic_1_comm[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
...
ggplot(topic_2_thr[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  labs(
...
ggplot(topic_3_comm[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
  geom_bar(stat = "identity", fill = "red") +
  labs(
