...
topic_1 = union(topic_1_thr, topic_1_comm)

ggplot(topic_1[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
...
topic_2 = union(topic_2_thr, topic_2_comm)

ggplot(topic_2[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
...
topic_3 = union(topic_3_thr, topic_3_comm)

ggplot(topic_3[1:10,], aes(x = reorder(as.factor(Id), -pageranks), y = pageranks)) +
